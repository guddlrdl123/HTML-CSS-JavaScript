...
4. getServerPort() : int - 연결할 때 사용된 포트 번호
...
9. getParameter(name)** : name에 해당된 파라미터 값을 구한다. 존재하지 않으면 null
10. getParameteValues(name)** : name에 속한 모든 파라미터르 배열로 구함. 존재하지 않으면 null
